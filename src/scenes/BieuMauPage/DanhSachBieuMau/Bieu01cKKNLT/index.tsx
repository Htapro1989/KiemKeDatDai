...
export default function Bieu01cKKNLT() {
    return (
        <div className='bieu-mau__layout-wrapper'>
            <HeaderBieuMau maBieu='Biểu số 01c/KKNLT' tenBieu='KIỂM KÊ TÌNH HÌNH QUẢN LÝ, SỬ DỤNG ĐẤT CỦA CÁC CÔNG TY NÔNG, LÂM NGHIỆP' />

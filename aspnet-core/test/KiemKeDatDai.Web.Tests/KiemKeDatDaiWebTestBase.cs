...
public abstract class KiemKeDatDaiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static KiemKeDatDaiWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(KiemKeDatDaiWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<KiemKeDatDaiDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<KiemKeDatDaiDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<KiemKeDatDaiDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<KiemKeDatDaiDbContext, Task<T>> func)
    {
        T result;

...
namespace KiemKeDatDai.RisApplication
{
    public class TrungUongAppService : KiemKeDatDaiAppServiceBase, ITrungUongAppService
    {
        ...
        public async Task<CommonResponseDto> DuyetBaoCaoTinh(string ma, long year, int loaiCapDvhc)
        {
                ...
                try
                {
                    ...
                    if (objdata != null)
                    {
                        ...
                        if (tinh != null)
                        {
                            ...
                            commonResponseDto = await CreateOrUpdateBieuTinh(objdata, ma, vung.Id, vung.MaVung, year, (int)HAM_DUYET.DUYET, loaiCapDvhc);
        ...
        public async Task<CommonResponseDto> HuyDuyetBaoCaoTinh(string ma, long year, int loaiCapDvhc)
        {
            CommonResponseDto commonResponseDto = new CommonResponseDto();
                ...
                try
                {
                    ...
                    if (objdata != null)
                    {
                        ...
                        if (tinh != null)
                        {
                            ...
                            {
                                commonResponseDto = await CreateOrUpdateBieuTinh(objdata, ma, vung.Id, vung.MaVung, year, (int)HAM_DUYET.HUY, loaiCapDvhc);
                            }
        ...
        private async Task<CommonResponseDto> CreateOrUpdateBieuTinh(DonViHanhChinh tinh, string maTinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            CommonResponseDto commonResponseDto = new CommonResponseDto();
            ...
            {
                await CreateOrUpdateBieu01TKKK_Tinh(data_bieu01TKKK, vungId, maVung, year, hamduyet, loaiCapDvhc);
            }
            else
            {
            ...
            {
                await CreateOrUpdateBieu02TKKK_Tinh(data_bieu02TKKK, vungId, maVung, year, hamduyet, loaiCapDvhc);
            }
            else
            {
            ...
            {
                await CreateOrUpdateBieu03TKKK_Tinh(data_bieu03TKKK, vungId, maVung, year, hamduyet, loaiCapDvhc);
            }
            else
            {
            ...
            {
                await CreateOrUpdateBieu04TKKK_Tinh(data_bieu04TKKK, vungId, maVung, year, hamduyet, loaiCapDvhc);
            }
            else
            {
            ...
            {
                await CreateOrUpdateBieu05TKKK_Tinh(data_bieu05TKKK, vungId, maVung, year, hamduyet, loaiCapDvhc);
            }
            else
            {
            ...
            {
                await CreateOrDeleteBieu06TKKKQPAN_Tinh(data_bieu06TKKKQPAN, vungId, maVung, year, hamduyet, loaiCapDvhc);
            }
            else
            {
        ...
        #region Biểu 01TKKK
        private async Task CreateOrUpdateBieu01TKKK_Tinh(List<Bieu01TKKK_Tinh> tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            ...
            if (data_TW.Count == 0)
            {
                foreach (var item in tinh)
                {
                    ...
                    await CreateBieu01TKKK_Tinh(item, vungId, maVung, loaiCapDvhc);
                }
            }
            else
            {
                foreach (var item in tinh)
                {
                    ...
                    await UpdateBieu01TKKK_Tinh(item, vungId, maVung, year, hamduyet, loaiCapDvhc);
                }
            }
        }

        private async Task CreateBieu01TKKK_Tinh(Bieu01TKKK_Tinh tinh, long vungId, string maVung, int loaiCapDvhc)
        {
            try
            {
        ...
        private async Task UpdateBieu01TKKK_Tinh(Bieu01TKKK_Tinh tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            try
            {
                //trung ương
                ...
                {
                    await CreateBieu01TKKK_Tinh(tinh, vungId, maVung, loaiCapDvhc);
                }
            }
            catch (Exception ex)
            {
        ...
        #region Biểu 02TKKK
        private async Task CreateOrUpdateBieu02TKKK_Tinh(List<Bieu02TKKK_Tinh> tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            ...
            if (data_TW.Count == 0)
            {
                ...
                {
                    //Tạo các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await CreateBieu02TKKK_Tinh(item, vungId, maVung, loaiCapDvhc);
                }
            }
            else
            {
                ...
                {
                    //Cập nhật các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await UpdateBieu02TKKK_Tinh(item, vungId, maVung, year, hamduyet, loaiCapDvhc);
                }
            }
        }

        private async Task CreateBieu02TKKK_Tinh(Bieu02TKKK_Tinh tinh, long vungId, string maVung, int loaiCapDvhc)
        {
            try
            {
                //Thêm mới bản ghi trung ương
        ...
        private async Task UpdateBieu02TKKK_Tinh(Bieu02TKKK_Tinh tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            try
            {
                ...
                {
                    await CreateBieu02TKKK_Tinh(tinh, vungId, maVung, loaiCapDvhc);
                }
            }
            catch (Exception ex)
            {
        ...
        #region Biểu 03TKKK
        private async Task CreateOrUpdateBieu03TKKK_Tinh(List<Bieu03TKKK_Tinh> tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            ...
            if (data_TW.Count == 0)
            {
                ...
                {
                    //Tạo các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await CreateBieu03TKKK_Tinh(item, vungId, maVung, loaiCapDvhc);
                }
            }
            else
            {
                ...
                {
                    //Cập nhật các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await UpdateBieu03TKKK_Tinh(item, vungId, maVung, year, hamduyet, loaiCapDvhc);
                }
            }
        }

        private async Task CreateBieu03TKKK_Tinh(Bieu03TKKK_Tinh tinh, long vungId, string maVung, int loaiCapDvhc)
        {
            try
            {
        ...
        private async Task UpdateBieu03TKKK_Tinh(Bieu03TKKK_Tinh tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            try
            {
                ...
                {
                    await CreateBieu03TKKK_Tinh(tinh, vungId, maVung, loaiCapDvhc);
                }
            }
            catch (Exception ex)
            {
        ...
        #region Biểu 04TKKK
        private async Task CreateOrUpdateBieu04TKKK_Tinh(List<Bieu04TKKK_Tinh> tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            ...
            if (data_TW.Count == 0)
            {
                ...
                {
                    //Tạo các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await CreateBieu04TKKK_Tinh(item, vungId, maVung, loaiCapDvhc);
                }
            }
            else
            {
                ...
                {
                    //Cập nhật các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await UpdateBieu04TKKK_Tinh(item, vungId, maVung, year, hamduyet, loaiCapDvhc);
                }
            }
        }

        private async Task CreateBieu04TKKK_Tinh(Bieu04TKKK_Tinh tinh, long vungId, string maVung, int loaiCapDvhc)
        {
            try
            {
                //Thêm mới bản ghi trung ương
                var objTW = new Bieu04TKKK()
                {
                    ...
                    DonViSuNghiep_TSN_DT = tinh.DonViSuNghiep_TSN_DT,
        ...
        private async Task UpdateBieu04TKKK_Tinh(Bieu04TKKK_Tinh tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            try
            {
                ...
                {
                    await CreateBieu04TKKK_Tinh(tinh, vungId, maVung, loaiCapDvhc);
                }
            }
            catch (Exception ex)
            {
        ...
        #region Biểu 05TKKK
        private async Task CreateOrUpdateBieu05TKKK_Tinh(List<Bieu05TKKK_Tinh> tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            ...
            if (data_TW.Count == 0)
            {
                ...
                {
                    //Tạo các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await CreateBieu05TKKK_Tinh(item, vungId, maVung, loaiCapDvhc);
                }
            }
            else
            {
                ...
                {
                    //Cập nhật các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await UpdateBieu05TKKK_Tinh(item, vungId, maVung, year, hamduyet, loaiCapDvhc);
                }
            }
        }

        private async Task CreateBieu05TKKK_Tinh(Bieu05TKKK_Tinh tinh, long vungId, string maVung, int loaiCapDvhc)
        {
            try
            {
                //Thêm mới bản ghi trung ương
        ...
        private async Task UpdateBieu05TKKK_Tinh(Bieu05TKKK_Tinh tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            try
            {
                ...
                {
                    await CreateBieu05TKKK_Tinh(tinh, vungId, maVung, loaiCapDvhc);
                }
            }
            catch (Exception ex)
            {
        ...
        #region Biểu 06TKKK
        private async Task CreateOrDeleteBieu06TKKKQPAN_Tinh(List<Bieu06TKKKQPAN_Tinh> tinh, long vungId, string maVung, long year, int hamduyet, int loaiCapDvhc)
        {
            ...
            if (hamduyet == (int)HAM_DUYET.DUYET)
            {
                ...
                {
                    //Tạo các bản ghi trung ương tương ứng với bản ghi tỉnh
                    await CreateBieu06TKKK(item, vungId, maVung, loaiCapDvhc);
                }
            }
            else
            {
                foreach (var item in tinh)
                {
                    ...
                    await DeleteBieu06TKKK(item, vungId, maVung, year, loaiCapDvhc);
                }
            }
        }

        private async Task CreateBieu06TKKK(Bieu06TKKKQPAN_Tinh tinh, long vungId, string maVung, int loaiCapDvhc)
        {
            try
            {
                //Thêm mới bản ghi trung ương
        ...
        private async Task DeleteBieu06TKKK(Bieu06TKKKQPAN_Tinh tinh, long vungId, string maVung, long year, int loaiCapDvhc)
        {
            try
            {
                //xoá biểu trung ương

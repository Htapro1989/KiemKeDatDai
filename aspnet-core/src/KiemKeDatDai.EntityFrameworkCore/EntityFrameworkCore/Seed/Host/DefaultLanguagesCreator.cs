...
namespace KiemKeDatDai.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly KiemKeDatDaiDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = KiemKeDatDaiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(KiemKeDatDaiDbContext context)
    {
        _context = context;
    }

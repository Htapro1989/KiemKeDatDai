...
namespace KiemKeDatDai.AppCore
{
    /// <summary>
    ...
    public class AppConsts
    {
        ...
        public const string API_domain = "http://svr2.dangduyhien.com/";
        public const string API_HoHamLon = "api-hohamlon/getmn.aspx?key=nolmahoh.16082023;";
